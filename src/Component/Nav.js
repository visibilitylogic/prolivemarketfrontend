...
const endpoint = "https://prolivemarkets-ykwsl.ondigitalocean.app";
...
function NavbarC(props) {
  ...
  useEffect(() => {
    let getSiteData = async () => {
      const res = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/site`
      );
  ...
  useEffect(() => {
    const funcE = async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/trade/user/${props.user.user.user._id}`
      );
  ...
  const saveCryptoCurrency = () => {
    ...
    fetch(
      `https://prolivemarkets-ykwsl.ondigitalocean.app/api/profile/usercryptodetails`,
      {
        mode: "cors",
        method: "PUT",
        headers: {
  ...
  const saveBankDetails = () => {
    ...
    fetch(
      `https://prolivemarkets-ykwsl.ondigitalocean.app/api/profile/userbankdetails`,
      {
        mode: "cors",
        method: "PUT",
        headers: {
  ...
  const BuyCoin = () => {
    ...
    fetch(`https://prolivemarkets-ykwsl.ondigitalocean.app/api/deposit`, {
      mode: "cors",
      method: "POST",
      headers: {
        Accept: "application/json",
  ...
  useEffect(() => {
    if (props && props.user) {
      const func2 = async () => {
        let response = await fetch(
          `https://prolivemarkets-ykwsl.ondigitalocean.app/api/profile/paymentDetails/${user.user.user.user._id}`
        );
        let data = await response.json();
