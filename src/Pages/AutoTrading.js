...
class AutoTrading extends Component {
  ...
  componentDidMount() {
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/allWithdraw`
      );
      let data = await response.json();
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/allDeposit`
      );
      let data = await response.json();
      console.log(data);
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/allVerify`
      );
      let data = await response.json();
      console.log(data);
  ...
  delete = (id) => {
    axios
      .delete(`https://prolivemarkets-ykwsl.ondigitalocean.app/api/copytrade/${id}`)
      .then(
        (response) => {
          (async () => {
            let res = await fetch(
  ...
  submit = () => {
    ...
    axios
      .post("https://prolivemarkets-ykwsl.ondigitalocean.app/api/copytrade", data)
      .then(
        (response) => {
          (async () => {
            let res = await fetch(
