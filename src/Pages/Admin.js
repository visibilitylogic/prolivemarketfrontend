...
class Admin extends Component {
  ...
  componentDidMount() {
    ...
    (async () => {
      let response = await fetch(`https://prolivemarkets-ykwsl.ondigitalocean.app/allUser`);
      let data = await response.json();
      console.log(data);
    ...
    (async () => {
      let response = await fetch(`https://prolivemarkets-ykwsl.ondigitalocean.app/allWithdraw`);
      let data = await response.json();
    ...
    (async () => {
      let response = await fetch(`https://prolivemarkets-ykwsl.ondigitalocean.app/allDeposit`);
      let data = await response.json();
      console.log(data);
    ...
    (async () => {
      let response = await fetch(`https://prolivemarkets-ykwsl.ondigitalocean.app/allTrade`);
    ...
    (async () => {
      let response = await fetch(`https://prolivemarkets-ykwsl.ondigitalocean.app/allVerify`);
      let data = await response.json();
      console.log(data);
