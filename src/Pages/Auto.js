...
class Auto extends Component {
  ...
  getSingleAutoTrade = (id) => {
    ...
    axios
      .get(`https://prolivemarkets-ykwsl.ondigitalocean.app/api/copytrade/${id}`)
      .then((response) => {
  ...
  subscribeAutotrade = (id) => {
    ...
    axios
      .put(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/copytrade/subscribe/${id}`,
        { userId: this.state.userId }
      )
      .then((response) => {
        const res = axios.put(
          `https://prolivemarkets-ykwsl.ondigitalocean.app/api/profile/autoTrade`,
          {
  ...
  unsubscribeAutotrade = (id) => {
    ...
    axios
      .put(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/copytrade/unsubscribe/${id}`,
        { userId: this.state.userId }
      )
      .then((response) => {
        const res = axios.put(
  ...
  componentDidMount() {
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/copytrade`
      );
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/trade/user/${
          this.state.user.user ? this.state.user.user.user._id : ""
        }`
      );
  ...
  closeOrder = (id, amount, newAmount) => () => {
    (async () => {
      ...
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/trade/close/${id}/${amount}/${newAmount}`
      );
      let value = id;
  ...
  handleSubmitBuy = (e) => {
    ...
    fetch(
      `https://prolivemarkets-ykwsl.ondigitalocean.app/api/trade/${this.state.user.user.user._id}`,
      {
        mode: "cors",
        method: "POST",
        headers: {
  ...
  handleSubmitFile = (e) => {
    ...
    fetch(
      `https://prolivemarkets-ykwsl.ondigitalocean.app/api/registration/file/${this.state.user.user.user._id}`,
      {
        mode: "cors",
        method: "POST",
        headers: {
