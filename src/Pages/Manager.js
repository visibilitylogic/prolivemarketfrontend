...
class Manager extends Component {
  ...
  callBackAutoTrade = (_id) => {
    (async () => {
      let res = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/autocopytrade/${_id}`
      );
  ...
  submitAutoCopyTrade = (_id) => {
    ...
    axios
      .post(
        "https://prolivemarkets-ykwsl.ondigitalocean.app/api/autocopytrade",
        payload
      )
      .then(
        (response) => {
  ...
  setCard = () => {
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/trade/desposit${
  ...
  updateAmount = () => {
    ...
    if (!this.state.credit && this.state.amount >= walletBal) {
      ...
      fetch(
        ` https://prolivemarkets-ykwsl.ondigitalocean.app/api/profile/CreditDebitAmount`,
        {
          mode: "cors",
          method: "PUT",
          headers: {
  ...
  handleLiveTrade = (id) => {
    ...
    //     `https://prolivemarkets-ykwsl.ondigitalocean.app/api/profile/single/${this.state.user.user.user._id}`
    //   );
    //   let user = await response.json();
    //   this.setState({
    //     user: user,
  ...
  declineVerify = (id, dmessage) => {
    fetch(`https://prolivemarkets-ykwsl.ondigitalocean.app/api/verify/decline`, {
      mode: "cors",
      method: "PUT",
      headers: {
        Accept: "application/json",
  ...
  approveVerify = (id) => {
    fetch(`https://prolivemarkets-ykwsl.ondigitalocean.app/api/verify/approve`, {
      mode: "cors",
      method: "PUT",
      headers: {
        Accept: "application/json",
  ...
  deleteUser = (id) => {
    fetch(`https://prolivemarkets-ykwsl.ondigitalocean.app/api/users/remove`, {
      mode: "cors",
      method: "DELETE",
      headers: {
        Accept: "application/json",
  ...
  componentDidMount() {
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/withdraw/AllHistory`
      );
      let data = await response.json();
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/trade/${
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/allUser`
      );
      let data = await response.json();
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/deposit/AllHistory`
      );
      let data = await response.json();
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/allTrade`
      );
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/verify`
      );
      let data = await response.json();
