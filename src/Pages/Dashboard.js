...
class Dashboard extends Component {
  ...
  handleTrading = (e) => {
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/profile/isTrading`,
        {
          mode: "cors",
          method: "PUT",
          headers: {
  ...
  componentDidMount() {
    ...
    (async () => {
      let response = await fetch(
        `https://prolivemarkets-ykwsl.ondigitalocean.app/api/autocopytrade/user/${
          this.state.user.user ? this.state.user.user.user._id : ""
        }`
      );
      let data = await response.json();
  ...
  handleSubmitVerification = (e) => {
    ...
    fetch(
      `https://prolivemarkets-ykwsl.ondigitalocean.app/api/verify/verificationrequest`,
      {
        mode: "cors",
        method: "POST",
        headers: {
